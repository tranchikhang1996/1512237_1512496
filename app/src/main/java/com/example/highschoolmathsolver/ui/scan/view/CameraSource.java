...
// reference: https://github.com/googlesamples/android-vision/blob/master/visionSamples/barcode-reader/app/src/main/java/com/google/android/gms/samples/vision/barcodereader/ui/camera/CameraSource.java
...
public class CameraSource {
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    Timber.d("[CameraSource] Frame processing thread interrupted on release.");
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Timber.d(e, "[CameraSource] Failed to clear camera preview");
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    public Pair<Integer, Integer> doZoom(float scale) {
        synchronized (mCameraLock) {
            if (mCamera == null) {
                return new Pair<>(0, 0);
            }
            ...
            if (!parameters.isZoomSupported()) {
                Timber.d("[CameraSource] Zoom is not supported on this device");
                return new Pair<>(0, 0);
            }
            int maxZoom = parameters.getMaxZoom();

            int currentZoom = parameters.getZoom();
            if ((currentZoom >= maxZoom && scale >= 1) || (currentZoom <= 0 && scale < 1)) {
                return new Pair<>(currentZoom, maxZoom);
            }
            float newZoom = scale >= 1 ? currentZoom + scale : scale > 0 ? currentZoom - scale : 0;
            currentZoom = Math.round(newZoom);
            currentZoom = currentZoom > maxZoom ? maxZoom : currentZoom >= 0 ? currentZoom : 0;
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Timber.d("[CameraSource] Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes() != null) {
                if (parameters.getSupportedFlashModes().contains(
                    ...
                    Timber.d("[CameraSource] Camera flash mode: " + mFlashMode + " is not supported on this device.");
                }
            }
        }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            Timber.d("[CameraSource] No preview sizes have a corresponding same-aspect-ratio picture size");
            for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (mLock) {
                ...
                if (!mBytesToByteBuffer.containsKey(data)) {
                    Timber.d("[CameraSource] Skipping frame.  Could not find ByteBuffer associated with the image data from the camera.");
                    return;
                }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            Timber.d(e,"[CameraSource] Frame processing loop terminated.");
                            return;
                        }
                    }
                ...
                try {
                    ...
                    Timber.d(t, "[CameraSource] Exception thrown from receiver.");
                } finally {
